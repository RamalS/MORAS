class Parser:
    ...
    def _parseLine(self, line, n):
        ...
        if l[0] == "push":
            if len(l) == 3 and self._checker(l[2]):
            ...
            if l[0] == "label" and len(l) == 2:
                self._labels2.append(l[1])
                return "//" + " ".join(l) + "\n" + self._label(l[1], n)
            elif l[0] == "goto" and len(l) == 2:
                self._labels1.append(l[1])
                return "//" + " ".join(l) + "\n" + self._goto(l[1], n)
    ...
    def _writeFile(self):
        for el in self._labels1:
            if el not in self._labels2:
                print("Error wrong label name found!")
                return ""
